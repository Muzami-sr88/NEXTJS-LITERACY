...
const CriticalPerspectivesHero = () => {
  return (
    <section
    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center lg:items-end">
          ...
          <div className="md:pl-6 lg:pl-17 transform translate-y-6 md:translate-y-12 lg:translate-y-24 md:-translate-x-4 lg:-translate-x-12 text-left">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white opacity-95 mt-8 leading-snug max-w-[80ch]">
              Critical perspectives explore theories, criticism, and philosophies to help readers analyze texts, uncover meaning, and connect literature to cultural and historical contexts.            </p>
          </div>

          {/* Right Illustration */}
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 lg:w-64 lg:h-64 transform translate-y-16 sm:translate-y-20 md:translate-y-28 lg:translate-y-38 md:-translate-x-11 lg:-translate-x-13">
              <Image
                src="/CriticalPerspectives_icon.svg"
                alt="Critical Perspectives Illustration"
                width={260}
                height={260}
                priority
      ...
      <div className="relative z-10 pb-0 -mb-6 px-2 sm:px-4 lg:px-6">
        <div className="w-full flex justify-center">
          <SearchRedirectForm target="/critical-perspectives" placeholder="Search Critical Perspectives by theories, critics, and ideas." />
        </div>
      </div>
    </section>
  );
...
export default CriticalPerspectivesHero;